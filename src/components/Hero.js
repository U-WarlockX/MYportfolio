...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Store the current ref values in variables to avoid changing during cleanup
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, #1F2833 1px, transparent 1px), linear-gradient(to bottom, #1F2833 1px, transparent 1px)",
      ...
      <div
        ...
        style={{ backgroundColor: "#45A29E", filter: "blur(50px)" }}
      ></div>
      <div
        className="absolute bottom-1/4 right-1/4 w-40 h-40 rounded-full opacity-15"
        style={{ backgroundColor: "#66FCF1", filter: "blur(60px)" }}
      ></div>

      {/* Loading Spinner */}
      <div ref={spinnerRef} className="absolute flex items-center justify-center opacity-100">
        <div
      ...
      {/* Content Container */}
      <div ref={containerRef} className="relative z-10 text-center px-4 opacity-0">
        ...
        <h1
          ...
          style={{ color: "#C5C6C7" }}
        >
          {/* The title text is dynamically updated with GSAP animation */}
          Hi, I'm Uvindu
          <span
            className="inline-block w-1 h-12 ml-1 animate-pulse"
